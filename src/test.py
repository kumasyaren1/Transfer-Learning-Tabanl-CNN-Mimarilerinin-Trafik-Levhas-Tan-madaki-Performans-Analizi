...
def predict_traffic_sign(image_path):
    ...
    img = np.expand_dims(img, axis=0) # Batch boyutu ekle: (1, 32, 32, 3)
...
# 6. TEST ETMEK İÇİN BİR RESİM YOLU VERİN
# Örnek olarak Train klasöründen bir resim seçelim:
test_image = os.path.join(BASE_DIR, "..", "data", "GTSRB", "Test","Images","05830.ppm")
